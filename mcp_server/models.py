...
class PropertyIdentifier(BaseModel):
    ...
    attom_id: Optional[str] = Field(
        None, description="ATTOM ID for the property"
    )
    address: Optional[str] = Field(
        None, description="Full address of the property"
    )
    ...
    fips: Optional[str] = Field(
        None, description="FIPS county code"
    )
    apn: Optional[str] = Field(
        None, description="Assessor Parcel Number"
    )
...
class AttomResponse(BaseModel):
    ...
    status_message: Optional[str] = Field(
        None, description="Status message from the API"
    )
    data: Dict[str, Any] = Field(
        default_factory=dict, description="API response data"
    )
